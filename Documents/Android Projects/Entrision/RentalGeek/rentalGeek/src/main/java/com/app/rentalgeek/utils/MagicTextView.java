 ...
 * @author George
 * 
 * @purpose Utils class which Shows border in the textview
 *
 */
public class MagicTextView extends TextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.MagicTextView_strokeColors)){
				float strokeWidth = a.getDimensionPixelSize(R.styleable.MagicTextView_strokeWidths, 1);
				int strokeColor = a.getColor(R.styleable.MagicTextView_strokeColors, 0xff000000);
