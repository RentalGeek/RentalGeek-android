...
import com.app.rentalgeek.backend.StarredBacked;
import com.app.rentalgeek.pojos.StarredListPojo;
import com.app.rentalgeek.utils.ConnectionDetector;
import com.app.rentalgeek.utils.RandomUtils;
			...
			if (detail.starred_properties.size() > 0) {
				...
				for (int i = 0; i < detail.starred_properties.size(); i++) {
					...
					mainlist.add(item.new StarredList(
							...
							detail.starred_properties.get(i).applicant_id,
