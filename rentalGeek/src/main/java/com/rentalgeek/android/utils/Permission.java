...
public class Permission {
    ...
    public static boolean granted(Context context, String permission) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            OkAlert.show(context, permissionGroup(permission) + " Permission", "Please grant Rental Geek '" + permissionGroup(permission) + "' permission in 'Settings > Apps > RentalGeek > Permissions'.");
            return false;
        }
